...
@class DGCFLAnimatedImage;
@protocol FLAnimatedImageViewDebugDelegate;


//
//  An `DGCFLAnimatedImageView` can take an `DGCFLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface DGCFLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) DGCFLAnimatedImage *animatedImage;
