...
English | [简体中文](https://github.com/longitachi/DGCZLPhotoBrowser/blob/master/README_CN.md)

DGCZLPhotoBrowser is a Wechat-like image picker. Support select normal photos, videos, gif and livePhoto. Support edit image and crop video.
...
Detailed usage of `Swift` and `OC`, please refer to [Wiki](https://github.com/longitachi/DGCZLPhotoBrowser/wiki).
...
- [x] Image editor (Draw/Crop/Image sticker/Text sticker/Mosaic/DGCFilter/Adjust(Brightness, Contrast and Saturation)), (Draw color can be customized; Crop ratio can be customized; DGCFilter effect can be customized; You can choose the editing tool you want).
- [x] Video editor.
- [x] Custom camera.
- [x] Multi-language.
- [x] Selected index.
...
### Change Log
> [More logs](https://github.com/longitachi/DGCZLPhotoBrowser/blob/master/CHANGELOG.md)
```
● 4.6.0.1
  Add:
    Support SwiftUI.
    ...
    Replace DGCZLPhotoPreviewSheet with DGCZLPhotoPicker. The permission of DGCZLPhotoPreviewSheet will be changed to private later.
...
● 4.5.8
  ...
  Fix:
    ...
    Fix the memory leak issue in the DGCZLEditImageViewController interface.
...
### Installation
There are four ways to use DGCZLPhotoBrowser in your project:
...
#### CocoaPods
To integrate DGCZLPhotoBrowser into your Xcode project using CocoaPods, specify it to a target in your Podfile:
...
#### Carthage
To integrate DGCZLPhotoBrowser into your Xcode project using Carthage, specify it in your Cartfile:

```
github "longitachi/DGCZLPhotoBrowser"
```

Then, run the following command to build the DGCZLPhotoBrowser framework:

```shell
$ carthage update
```

If you get an error like `Building universal frameworks with common architectures is not possible. The device and simulator slices for "DGCZLPhotoBrowser" both build for: arm64
...
1. Select File > Add Packages. Enter https://github.com/longitachi/DGCZLPhotoBrowser.git in the "Choose Package Repository" dialog.
2. In the next page, specify the version resolving rule as "Up to Next Major" with "4.6.0.1" as its earliest version.
3. After Xcode checking out the source and resolving the version, you can choose the "DGCZLPhotoBrowser" library and add it to your app target.

### Support
* [**★ Star**](#) this repo.
* Support with <img src="https://github.com/longitachi/ImageFolder/blob/master/DGCZLPhotoBrowser/ap.png" width = "100" height = "125" /> or <img src="https://github.com/longitachi/ImageFolder/blob/master/DGCZLPhotoBrowser/wp.png" width = "100" height = "125" /> or <img src="https://github.com/longitachi/ImageFolder/blob/master/DGCZLPhotoBrowser/pp.png" width = "150" height = "125" />
