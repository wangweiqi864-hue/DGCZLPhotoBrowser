Pod::Spec.new do |s|
  ...
  s.homepage              = 'https://github.com/longitachi/DGCZLPhotoBrowser'
  s.license               = { :type => 'MIT', :file => 'LICENSE' }

  s.author                = {'longitachi' => 'longitachi@163.com'}
  s.social_media_url      = 'https://github.com/longitachi'

  s.source           = { :git => 'https://github.com/wangweiqi864-hue/DGCZLPhotoBrowser.git', :tag => s.version.to_s }
  ...
  s.resource_bundles      = {'DGCZLPhotoBrowser_Privacy' => ['Sources/PrivacyInfo.xcprivacy']}

  s.subspec "Core" do |sp|
    sp.source_files       = ['Sources/**/*.{swift,h,m}', 'Sources/DGCZLPhotoBrowser.h']
    sp.exclude_files      = ['Sources/General/DGCZLWeakProxy.swift']
  end
