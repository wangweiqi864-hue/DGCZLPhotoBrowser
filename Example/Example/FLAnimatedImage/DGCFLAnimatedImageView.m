...
@optional
- (void)debug_animatedImageView:(DGCFLAnimatedImageView *)animatedImageView waitingForFrame:(NSUInteger)index duration:(NSTimeInterval)duration;
@end
#endif


@interface DGCFLAnimatedImageView ()
...
@implementation DGCFLAnimatedImageView
...
- (void)setAnimatedImage:(DGCFLAnimatedImage *)animatedImage
{
    if (![_animatedImage isEqual:animatedImage]) {
        if (animatedImage) {
            if (super.image) {
                ...
                // See more here: https://github.com/Flipboard/DGCFLAnimatedImage/issues/100
...
- (void)startAnimating
{
    if (self.animatedImage) {
        ...
        if (!self.displayLink) {
            ...
            DGCFLWeakProxy *weakProxy = [DGCFLWeakProxy weakProxyForObject:self];
