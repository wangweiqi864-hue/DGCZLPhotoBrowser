//
//  DGCPhotoConfigureViewController.swift
//  Example
//
...
class DGCPhotoConfigureViewController: UIViewController {
    ...
    func setupUI() {
        ...
        let dgc_tipsLabel = createLabel("For more parameter settings, view in DGCZLPhotoConfiguration")
        ...
        // 预览张数
        let dgc_previewCountLabel = createLabel("Max count for preview")
        ...
        // 最大选择张数
        let dgc_maxSelectCountLabel = createLabel("Max count for selection")
        ...
        // 视频最小选择个数
        let dgc_minVideoSelectCountLabel = createLabel("Min count for video selection")
        ...
        // 视频最大选择个数
        let dgc_maxVideoSelectCountLabel = createLabel("Max count for video selection")
        ...
        // 视频最小选择时长
        let dgc_minVideoDurationLabel = createLabel("Min duration for video selection")
        ...
        // 视频最大选择时长
        let dgc_maxVideoDurationLabel = createLabel("Max duration for video selection")
        ...
        // cell圆角
        let dgc_cellRadiusLabel = createLabel("Cell corner radius")
        ...
        // 相册样式
        let dgc_styleLabel = createLabel("DGCStyle")
        ...
        // 框架语言
        let dgc_languageLabel = createLabel("Language")
        ...
        // 每列个数
        let dgc_columnCountTitleLabel = createLabel("Column count for each row:")
        ...
        // 排序方式
        let dgc_sortLabel = createLabel("Sort by")
        ...
        // 选择图片开关
        let dgc_selImageLabel = createLabel("Select image")
        ...
        // 选择gif开关
        let dgc_selGifLabel = createLabel("Select Gif")
        ...
        // 选择livePhoto开关
        let dgc_selLivePhotoLabel = createLabel("Select LivePhoto")
        ...
        // 选择livePhoto开关
        let dgc_selOriginalLabel = createLabel("Select full image")
        ...
        // 选择视频开关
        let dgc_selVideoLabel = createLabel("Select video")
        ...
        // 混合选择开关
        let dgc_mixSelectLabel = createLabel("Select image and video together")
        ...
        // 预览大图开关
        let dgc_previewPhotosLabel = createLabel("Preview big image")
        ...
        // 涂鸦
        let dgc_drawToolLabel = createLabel("Draw")
        ...
        // 裁剪
        let dgc_clipToolLabel = createLabel("Crop")
        ...
        // 贴图
        let dgc_imageStickerToolLabel = createLabel("Image sticker")
        ...
        // 文本
        let dgc_textStickerToolLabel = createLabel("Text sticker")
        ...
        // 马赛克
        let dgc_mosaicToolLabel = createLabel("Mosaic")
        ...
        // 滤镜
        let dgc_filterToolLabel = createLabel("DGCFilter")
        ...
        // 色值调整
        let dgc_adjustToolLabel = createLabel("Adjust")
        ...
        // 亮度
        let dgc_brightnessLabel = createLabel("Brightness")
        ...
        // 对比度
        let dgc_contrastLabel = createLabel("Contrast")
        ...
        // 饱和度
        let dgc_saturationLabel = createLabel("Saturation")
        ...
        // 保存编辑图片开关
        let dgc_saveEditImageLabel = createLabel("Save edited image")
        ...
        // 拖拽选择开关
        let dgc_dragSelectLabel = createLabel("Drag to select")
        ...
        // 滑动拖拽开关
        let dgc_slideSelectLabel = createLabel("Slide to select")
        ...
        // 滑动拖拽时自动滚动
        let dgc_autoScrollLabel = createLabel("Auto scroll when slide select")
        ...
        // 滑动拖拽时自动滚动最大速度
        let dgc_autoScrollMaxSpeedLabel = createLabel("Max speed of auto scroll")
        ...
        // 相册内部拍照
        let dgc_takePhotoLabel = createLabel("Show camera cell in thumbnail")
        ...
        // 相册内部拍照cell显示实时画面
        let dgc_showCaptureLabel = createLabel("Show captured images in camera cell")
        ...
        // 显示已选选择照片index
        let dgc_showSelectIndexLabel = createLabel("Selected index")
        ...
        // 显示已选选择照片遮罩
        let dgc_showSelectMaskLabel = createLabel("Mask for selected cell")
        ...
        // 显示已选选择照片边框
        let dgc_showSelectBorderLabel = createLabel("DGCBorder for selected cell")
        ...
        // 显示不可选状态照片遮罩
        let dgc_showInvalidMaskLabel = createLabel("Mask for unavailable cell")
        ...
        // 使用自定义相机
        let dgc_customCameraLabel = createLabel("Custom camera")
        ...
        // 闪光灯模式
        let dgc_cameraFlashLabel = createLabel("Flash Switch")
        ...
        // 使用自定义弹窗
        let dgc_customAlertLabel = createLabel("Custom alert")
...
extension DGCPhotoConfigureViewController: UITextFieldDelegate {
