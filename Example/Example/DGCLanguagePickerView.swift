...
class DGCLanguagePickerView: UIView {
    ...
    var selectBlock: ( (DGCZLLanguageType) -> Void )?
    
    var selectedIndex = 0
    
    let languages = DGCZLLanguageType.allCases
    
    init(selectedLanguage: DGCZLLanguageType) {
...
extension DGCLanguagePickerView: UIPickerViewDelegate, UIPickerViewDataSource {
